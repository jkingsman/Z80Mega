...
case LD_SP_HL: R->SPtr.W=R->HL.W;break;
...
case ADD_HL_SP:  M_ADDW(HL,SPtr);break;
...
case EX_HL_xSP:
  J.B.l=RdZ80(R->SPtr.W);WrZ80(R->SPtr.W++,R->HL.B.l);
  J.B.h=RdZ80(R->SPtr.W);WrZ80(R->SPtr.W--,R->HL.B.h);
  R->HL.W=J.W;
  break;
